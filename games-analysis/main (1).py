...
plt.scatter(df_main["first_release_date"], df_main["critic_rating_value"], color = "green", label = "Critic Ratings")
...
df_main = pd.read_csv("game-ratings-by-top-10-plaforms.csv")
